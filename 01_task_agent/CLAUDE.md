...
1. Downloads a `people.csv` file from `https://hub.ag3nts.org/data/<API_KEY>/people.csv`
...
5. Submits results to `https://hub.ag3nts.org/verify` (task name: `people`)
...
- **Reference project**: `../04_task_agent/SpkAgent/` — same architecture pattern (Adapters, Config, Services, Tools, UI directories)
