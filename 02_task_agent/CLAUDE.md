...
3. Downloads power plant locations from `https://hub.ag3nts.org/data/<API_KEY>/findhim_locations.json`
...
6. Submits the answer to `POST https://hub.ag3nts.org/verify` (task name: `findhim`)
