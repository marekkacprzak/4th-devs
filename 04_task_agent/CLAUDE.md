...
1. Downloads shipping documentation from `https://hub.ag3nts.org/dane/doc/` (starting with `index.md`, then all referenced files)
...
4. Submits the completed declaration to `https://hub.ag3nts.org/verify` for validation
